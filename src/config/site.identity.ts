export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'innturtle',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Innturtle',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'innturtle.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://innturtle.com',
