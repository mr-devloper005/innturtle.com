...
export const pagesContent = {
  home: {
    metadata: {
      title: 'Discover local vendors, visuals, and featured listings',
      description: 'Search, browse, and compare image-led posts, business listings, and curated finds in one clean marketplace experience.',
      openGraphTitle: 'Discover local vendors, visuals, and featured listings',
      openGraphDescription: 'Explore a marketplace-style home for local vendors, visuals, stories, and curated resources.',
      keywords: ['local vendors', 'business listings', 'image discovery', 'marketplace'],
    },
    hero: {
      badge: 'Fresh this week',
      title: ['Find standout vendors, images,', 'and useful local discoveries.'],
      description: 'Search across listings, galleries, stories, and resources with a faster storefront layout built for quick scanning and deeper browsing.',
      primaryCta: { label: 'Browse listings', href: '/listing' },
      secondaryCta: { label: 'Explore images', href: '/image' },
      searchPlaceholder: 'Search vendors, products, services, and topics',
      focusLabel: 'Highlights',
      featureCardBadge: 'featured this week',
      featureCardTitle: 'Browse the latest visual and listing-driven highlights.',
      featureCardDescription: 'Recent posts and images shape the homepage while keeping the existing feed logic and route support intact.',
    },
    intro: {
    ...
    cta: {
      ...
      title: 'Move from quick search to deeper discovery without leaving the flow.',
      description: 'Browse visual posts, compare business listings, and open helpful resources through the same storefront-style navigation.',
      primaryCta: { label: 'Browse listings', href: '/listing' },
